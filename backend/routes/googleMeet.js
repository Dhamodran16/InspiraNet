...
const generateGoogleMeetLink = () => {
  ...
  // Using the same format as Google Meet: 3 letters, 4 letters, 3 letters
...
// Join a Google Meet room (increment participant count)
...
// Leave a Google Meet room (decrement participant count)
  ...
  try {
    ...
    res.json({
      ...
      stats: {
        ...
        max_participants: room.max_participants,
        created_at: room.created_at,
        total_views: room.current_participants, // This could be enhanced with actual view tracking
