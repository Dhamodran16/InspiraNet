...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    if (section && ['home', 'network', 'messages', 'notifications', 'placements', 'meetings', 'profile', 'settings'].includes(section)) {
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 ml-16 flex flex-col">
        ...
        <main className="flex-1 overflow-hidden">
          <div className="h-full dashboard-section overflow-y-auto">
            <ErrorBoundary>
              {renderSection()}
            </ErrorBoundary>
          </div>
