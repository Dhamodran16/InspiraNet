      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className={`border ${isDark ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'}`}>
            <CardHeader>
              <CardTitle className={`flex items-center gap-2 text-2xl ${isDark ? 'text-blue-400' : 'text-blue-800'}`}>
                <Cookie className={`h-6 w-6 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
                Cookie Policy
              </CardTitle>
            </CardHeader>
          ...
          <Card className={`border ${isDark ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'}`}>
            <CardHeader>
              <CardTitle className={`flex items-center gap-2 ${isDark ? 'text-blue-400' : 'text-blue-800'}`}>
                <Info className={`h-5 w-5 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} />
                What Are Cookies?
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card className={`border ${isDark ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'}`}>
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className={`font-semibold mb-2 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Essential Cookies</h4>
              ...
              <div>
                <h4 className={`font-semibold mb-2 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Analytics Cookies</h4>
                <p className={`mb-4 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
              ...
              <div>
                <h4 className={`font-semibold mb-2 ${isDark ? 'text-gray-100' : 'text-gray-900'}`}>Preference Cookies</h4>
                <p className={`mb-4 ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
          ...
          <Card className={`border ${isDark ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'}`}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className={`bg-blue-50 p-4 rounded-lg ${isDark ? 'bg-blue-900' : ''}`}>
                <p className={`text-blue-800 text-sm ${isDark ? 'text-blue-400' : ''}`}>
