...
export default function EnhancedNotificationSystem() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-0 sm:px-6 py-4 md:py-6 pb-20 md:pb-6">
      <div className="mb-6">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold flex items-center gap-2 sm:gap-3 px-4 sm:px-0">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
        ...
        <TabsContent value="notifications" className="outline-none">
          <Card className="border-0 sm:border shadow-none sm:shadow bg-transparent sm:bg-card">
            <CardHeader className="p-4 md:p-6 pb-2 md:pb-3 hidden sm:block">
